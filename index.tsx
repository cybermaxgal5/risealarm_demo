        ...
        <div className="mt-6">
          <div className="relative overflow-hidden rounded-[1.75rem] bg-black border border-black/20 aspect-video shadow-2xl group">
            ...
            <button
              ...
              className={`absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#FF6B00]/20 via-black/40 to-black/60 hover:opacity-80 transition-opacity cursor-pointer group ${isMuted ? '' : 'opacity-0 hover:opacity-100'}`}
